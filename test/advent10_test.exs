defmodule Advent10Test do
  ...
  test "arrange combinations count on small provided example" do
    ...
    assert Advent10.arrange_combinations_count([16, 10, 15, 5, 1, 11, 7, 19, 6, 12, 4]) == 8
  end

  test "single possibile combination" do
    assert Advent10.arrange_combinations_count([3,6,9,12,15]) == 1
  end
  
  test "two possibile combination" do
    # 3 6 7 8 11
    # 3 6 8 11
    assert Advent10.arrange_combinations_count([3,6,7,8,11]) == 2
  end
  ...
  test "4 possibile combination" do
    ...
    # 3 6
    # 3 4 6
    assert Advent10.arrange_combinations_count([3,4,5,6]) == 4
  end
  ...
  test "n possibile combination" do
    ...
    #
    # (0) 3 6 7 (10)
    assert Advent10.arrange_combinations_count([3,4,5,6,7]) == 7
  end
  ...
  test "arrange combinations count on larger provided example" do
    ...
    assert Advent10.arrange_combinations_count(input) == 19208
  end
